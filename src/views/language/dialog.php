...
/* @var $languageSource \dlds\translatemanager\models\LanguageSource */
/* @var $languageTranslate \dlds\translatemanager\models\LanguageTranslate */
?>
<div id="translate-manager-dialog">
    ...
    <div class="translate-manager-message">
        <div class="clearfix">
            ...
            <?= $form->field($languageTranslate, 'language', ['enableLabel' => false])->hiddenInput(['name' => 'code']) ?>
